...
public partial class VitalContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=NOTE02-SALA19; initial catalog=VitalHub_G9T_V2; user Id = sa; pwd=Senai@134; TrustServerCertificate=true;");
    //=> optionsBuilder.UseSqlServer("Data Source=DESKTOP-84UMQCT\\SQLEXPRESS; initial catalog=VitalHub_G10; user Id = sa; pwd=Senai@134; TrustServerCertificate=true;");
